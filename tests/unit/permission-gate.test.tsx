...
describe('PermissionGate', () => {
  it('renders children when user has the required permission', () => {
    mockUsePermissions.mockReturnValue({ isLoading: false } as ReturnType<typeof usePermissions>);
  ...
  it('renders fallback when user lacks the required permission', () => {
    ...
    render(
      <PermissionGate permission="users:read" fallback={<span>Access denied</span>}>
        <span>Protected content</span>
      </PermissionGate>
    );
  ...
  it('renders null while permissions are loading (regardless of permission value)', () => {
    mockUsePermissions.mockReturnValue({ isLoading: true } as ReturnType<typeof usePermissions>);
    mockUseHasPermission.mockReturnValue(true);
