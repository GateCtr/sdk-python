...
describe('AdminSidebar', () => {
  ...
  describe('SUPER_ADMIN – sees all menu items', () => {
    ...
    it('renders links with correct hrefs', () => {
      ...
      expect(screen.getByRole('link', { name: 'sidebar.users' })).toHaveAttribute('href', '/admin/users');
      expect(screen.getByRole('link', { name: 'sidebar.plans' })).toHaveAttribute('href', '/admin/plans');
      expect(screen.getByRole('link', { name: 'sidebar.featureFlags' })).toHaveAttribute('href', '/admin/feature-flags');
      expect(screen.getByRole('link', { name: 'sidebar.auditLogs' })).toHaveAttribute('href', '/admin/audit-logs');
      expect(screen.getByRole('link', { name: 'sidebar.systemHealth' })).toHaveAttribute('href', '/admin/system');
      expect(screen.getByRole('link', { name: 'sidebar.waitlist' })).toHaveAttribute('href', '/admin/waitlist');
    });
  });
