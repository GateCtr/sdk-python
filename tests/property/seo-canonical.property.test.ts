...
import { buildCanonicalUrl, buildAlternateUrls, getSeoContextWithHost } from '@/lib/seo';
    ...
    fc.assert(
      fc.property(
        ...
        (locale, path) => {
          ...
          const startsWithMarketing = url.startsWith(mockMarketingContext.marketingUrl);
