...
test.describe('Sign-in page', () => {
  ...
  test('sign-in page contains Clerk sign-in component', async ({ page }) => {
    ...
    const clerkElement = page.locator('[data-clerk-component], .cl-rootBox, form, iframe').first();
  ...
  test('sign-in page contains language switcher', async ({ page }) => {
    ...
    const languageSwitcher = page.locator('[data-testid="language-switcher"], button').filter({ hasText: /en|fr|english|french|langue/i }).first();
...
test.describe('Locale preservation during authentication', () => {
  ...
  test('unauthenticated access to protected route redirects to sign-in with redirect_url', async ({ page }) => {
    /**
  ...
  test('unauthenticated access to French protected route redirects to French sign-in', async ({ page }) => {
    /**
...
test.describe('Sign-in redirect to dashboard', () => {
   ...
   */
  test('sign-in page has fallbackRedirectUrl pointing to dashboard', async ({ page }) => {
    await page.goto('/sign-in');
    await page.waitForLoadState('networkidle');
