...
test.describe('French locale displays French content (Requirement 1.8, 7.7)', () => {
  test('French sign-in page renders expected French heading', async ({ page }) => {
    await page.goto('/fr/sign-in');
    await page.waitForLoadState('networkidle');
    // French translation: "Connexion à GateCtr"
    await expect(page.getByRole('heading', { name: /connexion à gatectr/i })).toBeVisible();
  });

  test('French sign-up page renders expected French heading', async ({ page }) => {
    await page.goto('/fr/sign-up');
    await page.waitForLoadState('networkidle');
    // French translation: "Créer votre compte GateCtr"
    await expect(page.getByRole('heading', { name: /créer votre compte gatectr/i })).toBeVisible();
  });
  ...
  test('English sign-in page renders English heading', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /sign in to gatectr/i })).toBeVisible();
  });
  ...
  test('English sign-up page renders English heading', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /create your gatectr account/i })).toBeVisible();
  });
});

test.describe('LanguageSwitcher component on auth pages (Requirement 1.8)', () => {
  test('LanguageSwitcher is present on English sign-in page', async ({ page }) => {
    await page.goto('/sign-in');
    await page.waitForLoadState('networkidle');
  ...
  test('LanguageSwitcher is present on French sign-in page', async ({ page }) => {
    await page.goto('/fr/sign-in');
    await page.waitForLoadState('networkidle');
    const languageSwitcher = page
      .locator('button')
  ...
  test('LanguageSwitcher is present on English sign-up page', async ({ page }) => {
    await page.goto('/sign-up');
    await page.waitForLoadState('networkidle');
    const languageSwitcher = page
      .locator('button')
...
test.describe('Locale switching via URL navigation (Requirement 15.5, 17.4)', () => {
   ...
   */
  test('navigating from /sign-in to /fr/sign-in switches to French locale', async ({ page }) => {
    await page.goto('/sign-in');
    await page.waitForLoadState('domcontentloaded');
    await expect(page).toHaveURL(/^http:\/\/localhost:3000\/sign-in/);
  ...
  test('locale is preserved when navigating between pages in French locale', async ({ page }) => {
  ...
  test('locale is preserved when navigating between pages in English locale', async ({ page }) => {
    ...
    await page.goto('/sign-up');
    await page.waitForURL(/^http:\/\/localhost:3000\/sign-up/, { timeout: 10000 });
    await expect(page).toHaveURL(/^http:\/\/localhost:3000\/sign-up/);
  });
});
...
test.describe('Locale preserved during authentication flow (Requirement 7.7, 17.4)', () => {
   ...
   */
  test('French sign-in URL preserves /fr/ locale prefix after page load', async ({ page }) => {
    await page.goto('/fr/sign-in');
    await page.waitForLoadState('networkidle');
  ...
  test('French sign-up URL preserves /fr/ locale prefix after page load', async ({ page }) => {
    await page.goto('/fr/sign-up');
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveURL(/\/fr\/sign-up/);
  });
  ...
  test('French sign-in page does not redirect to English version', async ({ page }) => {
    await page.goto('/fr/sign-in');
    await page.waitForLoadState('networkidle');
