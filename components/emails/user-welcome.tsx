        ...
        <Container style={container}>
          ...
          <Section style={footer}>
            ...
            <Text style={footerText}>
              ...
              {' · '}
              <Link href={`${process.env.NEXT_PUBLIC_APP_URL}/unsubscribe?email=${email}`} style={footerLink}>{c.unsub}</Link>
            </Text>
          </Section>
        </Container>
      </Body>
...
const contentEn = {
  ...
  cta: 'Open dashboard',
  items: [
    { title: '💰 Budget Firewall', desc: 'Hard caps. Soft alerts. No surprise invoices.' },
    { title: '⚡ Context Optimizer', desc: '-40% tokens. Same output quality.' },
    { title: '🎯 Model Router', desc: 'GateCtr picks the right LLM. You pay less.' },
  ],
...
const contentFr = {
  ...
  items: [
    { title: '💰 Budget Firewall', desc: 'Limites strictes. Alertes douces. Zéro facture surprise.' },
    { title: '⚡ Context Optimizer', desc: '-40% de tokens. Même qualité de sortie.' },
    { title: '🎯 Model Router', desc: 'GateCtr choisit le bon LLM. Vous payez moins.' },
  ],
...
const featureItem = { color: '#4a5568', fontSize: '14px', lineHeight: '1.6', margin: '0 0 14px' };
