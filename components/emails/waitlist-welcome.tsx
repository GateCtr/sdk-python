...
export default function WaitlistWelcomeEmail({ name, position, email }: WaitlistWelcomeEmailProps) {
  return (
    <Html>
      <Head />
...
const positionLabel = { color: 'rgba(255,255,255,0.8)', fontSize: '13px', fontWeight: '500', margin: '0 0 6px' };
const positionNumber = { color: '#ffffff', fontSize: '52px', fontWeight: '700', margin: '0', lineHeight: '1' };
const features = { backgroundColor: '#f8fafc', borderRadius: '8px', padding: '24px', margin: '0 0 24px' };
const featuresTitle = { color: '#718096', fontSize: '12px', fontWeight: '600', textTransform: 'uppercase' as const, letterSpacing: '0.05em', margin: '0 0 16px' };
