...
function SocialLinks({ githubLabel, xLabel }: { githubLabel: string; xLabel: string }) {
  return (
...
export function Footer({ variant = 'marketing', className }: FooterProps) {
    ...
    return (
      <footer className={cn('py-4 px-6', className)}>
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
          ...
          <span aria-hidden>·</span>
          <a href="mailto:support@gatectr.com" className="hover:text-foreground transition-colors">
            {t('footer.help')}
          </a>
          <span aria-hidden>·</span>
  ...
  if (variant === 'minimal') {
    return (
      <footer className={cn('border-t border-border bg-background py-4', className)}>
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between text-sm text-muted-foreground">
          <Logo variant="full" iconClassName="w-5 h-5" textClassName="text-base" />
          <span>{t('footer.copyright', { year })}</span>
        </div>
      </footer>
    );
    ...
    <footer className={cn('border-t border-border bg-background', className)}>
      <div className="max-w-7xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          {/* Resources */}
          <div>
            <h4 className="text-sm font-semibold mb-3">{t('footer.resources')}</h4>
            <ul className="space-y-2.5">
              <li>
                <a
