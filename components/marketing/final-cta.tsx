  ...
  return (
    <section className="py-24 px-4 bg-primary/5 border-t border-border">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">{t('headline')}</h2>
        <p className="text-muted-foreground mb-10">{t('description', { setupTime: PRODUCT.metrics.setupTime })}</p>
