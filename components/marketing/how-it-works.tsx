...
export function HowItWorks() {
  ...
  const rawSteps = t.raw('steps') as Array<{ step: string; title: string; description: string }>;
  const steps = rawSteps.map((s) => ({ ...s, description: interpolate(s.description, STEP_VARS) }));
